...
The end state of
[defining a calculus](../../tutorials/defining-a-calculus.md): a Eunoia
...
| [`Resolution.eos`](Resolution.eos) | the semantics. **Not compiled here** — see the tutorial's [what was checked](../../tutorials/defining-a-calculus.md#what-was-checked-and-what-was-not) |
...
`ethos` checks a proof against a signature. It is not a checker generated by
eudaimonia, it does not produce that framework's four verdicts, and nothing
here establishes that these rules are sound.
